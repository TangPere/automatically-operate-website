...
public class ChaoJiYing {
    ...
    public static String UserReg(String username, String password) {
        ...
        String result;
        try {
            result = ChaoJiYing.httpRequestData("http://upload.chaojiying.net/Upload/UserReg.php", param);
        } catch (IOException e) {
            result = "未知问题";
        }
        return result;
    ...
    public static String UserPay(String username, String card) {
        ...
        String result;
        try {
            result = ChaoJiYing.httpRequestData("http://upload.chaojiying.net/Upload/UserPay.php", param);
        } catch (IOException e) {
            result = "未知问题";
        }
        return result;
    ...
    private static String httpPostImage(String param, byte[] data) throws IOException {
        ...
        for (String paramValue : param.split("[&]")) {
            ...
            String paramString =
                "Content-Disposition: form-data; name=\"" + paramValue.split("[=]")[0] + "\"\r\n\r\n" + paramValue.split("[=]")[1];
    ...
    public static String getVerifyCode() {
        ...
        String result = ChaoJiYing.PostPic("PereTang", "sichun.7", "893486", "1902", "0", "verifycode.png");
        JSONObject resultJson = (JSONObject) JSONObject.parse(result);
        return resultJson.getString("pic_str");
    }
